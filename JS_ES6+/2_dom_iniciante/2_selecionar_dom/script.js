...
ID: getElementById seleciona e retorna elementos do DOM pelo ID / Retorna null caso não exista.
ex: const animaisSection = document.getElementById('animais');
...
HTMLCOLLECTION -> length, item(), namedItem()  --->  Atualiza
NODELIST -> length, item(), entries(), forEach(), keys(), values()  --->  Estático
...
ex :  const array = Array.from(gridSectionHTML)
tornou-se uma NodeList, ou seja, herdou seus metodos e agora é estático
*/