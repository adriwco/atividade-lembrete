...
// OPERADORES DE COMPARAÇÃO : sempre retornar um valor booleano
10 > 5; // true
5 > 10; // false
20 < 10; // false
10 <= 10 // true
...
// OPERADORES DE COMPARAÇÃO : O == faz uma comparação não tão restrita e o === faz uma comparação restrita, ou seja, o tipo de dado deve ser o mesmo quando usamos ===
0 == '10'; // true
10 == 10; // true
10 === '10'; // false
10 === 10 // true
